  ...
  <ul class="dropdown-menu" >
	...
	<li> <a href="../destroy"><i class="fa fa-sign-out"></i>&nbsp;&nbsp; Logout</a> </li>
              ...
              <ul class="main-nav nav navbar-nav navbar-right">
                <li class="wow fadeInDown" data-wow-delay="0s"><a class="active"  href="./partener.jsp">Acceuil</a></li>
        ...
        <div class="content-area">
            <div class="container">
                ...
                <div class="row how-it-work text-center">
                    ...
                    <div class="col-md-4">
                        <a href="./ajouter_offre.jsp"><div class="single-work  wow fadeInUp"  data-wow-delay="0.9s">
                            <img src="../img/how-work2.png" alt="">
                            <h3>Ajouter un offre</h3>
                            <p>Un partenaire peut ajouter un offre avec le formulaire et peut ajouter aussi des pièces jointe</p>
                        </div></a>
                    </div>
                    <div class="col-md-4">
