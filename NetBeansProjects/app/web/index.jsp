...
<header class="header" id="header"><!--header-start-->
	<div class="container">
        ...
        <ul class="we-create animated fadeInUp delay-1s">
        	<li>JOB est un site web pour les partenaires et les programmeurs</li>
       </ul>
            <a class="link animated fadeInUp " href="login.jsp">LOGIN</a>
            <a class="link animated fadeInUp " href="inscription.jsp">INSCRIPTION</a>
